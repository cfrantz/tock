...
// at least.
pub(crate) static mut PROCESSES: [Option<&'static dyn kernel::process::Process>; 4] = [None; NUM_PROCS];
...
#[cfg(test)]
pub(crate) static mut PLATFORM: Option<&'static EarlGreyNexysVideo> = None;
...
pub(crate) static mut ALARM: Option<&'static MuxAlarm<'static, earlgrey::timer::RvTimer<'static>>> = None;
...
pub(crate) static mut AES: Option<&virtual_aes_ccm::VirtualAES128CCM<'static, earlgrey::aes::Aes<'static>>> =
    None;
// Test access to SipHash
pub(crate) static mut SIPHASH: Option<&capsules::sip_hash::SipHasher24<'static>> = None;

pub(crate) static mut CHIP: Option<&'static earlgrey::chip::EarlGrey<EarlGreyDefaultPeripherals>> = None;
pub(crate) static mut PROCESS_PRINTER: Option<&'static kernel::process::ProcessPrinterText> = None;

// How should the kernel respond when a process faults.
pub(crate) const FAULT_RESPONSE: kernel::process::PanicFaultPolicy = kernel::process::PanicFaultPolicy {};
