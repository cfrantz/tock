...
register_bitfields![u32,
    ...
    MIO_PERIPH_INSEL [
        pub(crate) IN_0 OFFSET(0) NUMBITS(6) [],
    ],
    MIO_OUTSEL_REGWEN [
        pub(crate) EN_0 OFFSET(0) NUMBITS(1) [],
    ],
    MIO_OUTSEL [
        pub(crate) OUT_0 OFFSET(0) NUMBITS(6) [],
    ],
    MIO_PAD_ATTR_REGWEN [
        pub(crate) EN_0 OFFSET(0) NUMBITS(1) [],
    ],
    MIO_PAD_ATTR [
        ...
        pub(crate) VIRTUAL_OD_EN_0 OFFSET(1) NUMBITS(1) [],
        pub(crate) PULL_EN_0 OFFSET(2) NUMBITS(1) [],
        pub(crate) PULL_SELECT_0 OFFSET(3) NUMBITS(1) [
            PULL_DOWN = 0,
            PULL_UP = 1,
        ],
        pub(crate) KEEPER_EN_0 OFFSET(4) NUMBITS(1) [],
        pub(crate) SCHMITT_EN_0 OFFSET(5) NUMBITS(1) [],
        pub(crate) OD_EN_0 OFFSET(6) NUMBITS(1) [],
        pub(crate) SLEW_RATE_0 OFFSET(16) NUMBITS(2) [],
        pub(crate) DRIVE_STRENGTH_0 OFFSET(20) NUMBITS(4) [],
    ],
    DIO_PAD_ATTR_REGWEN [
        pub(crate) EN_0 OFFSET(0) NUMBITS(1) [],
    ],
    ...
    MIO_PAD_SLEEP_STAT [
        ...
        pub(crate) EN_6 OFFSET(6) NUMBITS(1) [],
        pub(crate) EN_7 OFFSET(7) NUMBITS(1) [],
        pub(crate) EN_8 OFFSET(8) NUMBITS(1) [],
        pub(crate) EN_9 OFFSET(9) NUMBITS(1) [],
        pub(crate) EN_10 OFFSET(10) NUMBITS(1) [],
        pub(crate) EN_11 OFFSET(11) NUMBITS(1) [],
        pub(crate) EN_12 OFFSET(12) NUMBITS(1) [],
        pub(crate) EN_13 OFFSET(13) NUMBITS(1) [],
        pub(crate) EN_14 OFFSET(14) NUMBITS(1) [],
        pub(crate) EN_15 OFFSET(15) NUMBITS(1) [],
        pub(crate) EN_16 OFFSET(16) NUMBITS(1) [],
        pub(crate) EN_17 OFFSET(17) NUMBITS(1) [],
        pub(crate) EN_18 OFFSET(18) NUMBITS(1) [],
        pub(crate) EN_19 OFFSET(19) NUMBITS(1) [],
        pub(crate) EN_20 OFFSET(20) NUMBITS(1) [],
        pub(crate) EN_21 OFFSET(21) NUMBITS(1) [],
        pub(crate) EN_22 OFFSET(22) NUMBITS(1) [],
        pub(crate) EN_23 OFFSET(23) NUMBITS(1) [],
        pub(crate) EN_24 OFFSET(24) NUMBITS(1) [],
        pub(crate) EN_25 OFFSET(25) NUMBITS(1) [],
        pub(crate) EN_26 OFFSET(26) NUMBITS(1) [],
        pub(crate) EN_27 OFFSET(27) NUMBITS(1) [],
        pub(crate) EN_28 OFFSET(28) NUMBITS(1) [],
        pub(crate) EN_29 OFFSET(29) NUMBITS(1) [],
        pub(crate) EN_30 OFFSET(30) NUMBITS(1) [],
        pub(crate) EN_31 OFFSET(31) NUMBITS(1) [],
    ],
    ...
    MIO_PAD_SLEEP_MODE [
        pub(crate) OUT_0 OFFSET(0) NUMBITS(2) [
            TIE-LOW = 0,
            TIE-HIGH = 1,
            HIGH-Z = 2,
            KEEP = 3,
    ...
    WKUP_DETECTOR [
        pub(crate) MODE_0 OFFSET(0) NUMBITS(3) [
            POSEDGE = 0,
            NEGEDGE = 1,
            EDGE = 2,
            TIMEDHIGH = 3,
        ...
        pub(crate) FILTER_0 OFFSET(3) NUMBITS(1) [],
        pub(crate) MIODIO_0 OFFSET(4) NUMBITS(1) [],
    ],
    WKUP_DETECTOR_CNT_TH [
        pub(crate) TH_0 OFFSET(0) NUMBITS(8) [],
    ],
    WKUP_DETECTOR_PADSEL [
        pub(crate) SEL_0 OFFSET(0) NUMBITS(6) [],
    ],
    WKUP_CAU [
        pub(crate) CAUSE_0 OFFSET(0) NUMBITS(1) [],
        pub(crate) CAUSE_1 OFFSET(1) NUMBITS(1) [],
        pub(crate) CAUSE_2 OFFSET(2) NUMBITS(1) [],
        pub(crate) CAUSE_3 OFFSET(3) NUMBITS(1) [],
        pub(crate) CAUSE_4 OFFSET(4) NUMBITS(1) [],
        pub(crate) CAUSE_5 OFFSET(5) NUMBITS(1) [],
        pub(crate) CAUSE_6 OFFSET(6) NUMBITS(1) [],
        pub(crate) CAUSE_7 OFFSET(7) NUMBITS(1) [],
    ],
];
