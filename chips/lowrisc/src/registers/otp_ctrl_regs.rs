...
pub const OTP_CTRL_PARAM_CREATOR_SW_CFG_AST_CFG_SIZE: u32 = 128;
// Offset of CREATOR_SW_CFG_AST_INIT_EN
pub const OTP_CTRL_PARAM_CREATOR_SW_CFG_AST_INIT_EN_OFFSET: usize = 192;
...
pub const OTP_CTRL_PARAM_CREATOR_SW_CFG_ROM_EXT_SKU_OFFSET: usize = 196;
...
pub const OTP_CTRL_PARAM_CREATOR_SW_CFG_USE_SW_RSA_VERIFY_OFFSET: usize = 200;
...
pub const OTP_CTRL_PARAM_CREATOR_SW_CFG_KEY_IS_VALID_OFFSET: usize = 204;
...
pub const OTP_CTRL_PARAM_CREATOR_SW_CFG_FLASH_DATA_DEFAULT_CFG_OFFSET: usize = 212;
...
pub const OTP_CTRL_PARAM_CREATOR_SW_CFG_FLASH_INFO_BOOT_DATA_CFG_OFFSET: usize = 216;
...
pub const OTP_CTRL_PARAM_CREATOR_SW_CFG_RNG_EN_OFFSET: usize = 220;
...
register_bitfields![u32,
    ...
    INTR [
        pub(crate) OTP_OPERATION_DONE OFFSET(0) NUMBITS(1) [],
        pub(crate) OTP_ERROR OFFSET(1) NUMBITS(1) [],
    ],
    ALERT_TEST [
        pub(crate) FATAL_MACRO_ERROR OFFSET(0) NUMBITS(1) [],
        pub(crate) FATAL_CHECK_ERROR OFFSET(1) NUMBITS(1) [],
        pub(crate) FATAL_BUS_INTEG_ERROR OFFSET(2) NUMBITS(1) [],
    ],
    STATUS [
        pub(crate) VENDOR_TEST_ERROR OFFSET(0) NUMBITS(1) [],
        pub(crate) CREATOR_SW_CFG_ERROR OFFSET(1) NUMBITS(1) [],
        pub(crate) OWNER_SW_CFG_ERROR OFFSET(2) NUMBITS(1) [],
        pub(crate) HW_CFG_ERROR OFFSET(3) NUMBITS(1) [],
        pub(crate) SECRET0_ERROR OFFSET(4) NUMBITS(1) [],
        pub(crate) SECRET1_ERROR OFFSET(5) NUMBITS(1) [],
        pub(crate) SECRET2_ERROR OFFSET(6) NUMBITS(1) [],
        pub(crate) LIFE_CYCLE_ERROR OFFSET(7) NUMBITS(1) [],
        pub(crate) DAI_ERROR OFFSET(8) NUMBITS(1) [],
        pub(crate) LCI_ERROR OFFSET(9) NUMBITS(1) [],
        pub(crate) TIMEOUT_ERROR OFFSET(10) NUMBITS(1) [],
        pub(crate) LFSR_FSM_ERROR OFFSET(11) NUMBITS(1) [],
        pub(crate) SCRAMBLING_FSM_ERROR OFFSET(12) NUMBITS(1) [],
        pub(crate) KEY_DERIV_FSM_ERROR OFFSET(13) NUMBITS(1) [],
        pub(crate) BUS_INTEG_ERROR OFFSET(14) NUMBITS(1) [],
        pub(crate) DAI_IDLE OFFSET(15) NUMBITS(1) [],
        pub(crate) CHECK_PENDING OFFSET(16) NUMBITS(1) [],
    ],
    ERR_CO [
        pub(crate) ERR_CODE_0 OFFSET(0) NUMBITS(3) [
            NO_ERROR = 0,
            MACRO_ERROR = 1,
        ...
        pub(crate) ERR_CODE_1 OFFSET(3) NUMBITS(3) [
            NO_ERROR = 0,
            MACRO_ERROR = 1,
            MACRO_ECC_CORR_ERROR = 2,
            MACRO_ECC_UNCORR_ERROR = 3,
        ...
        pub(crate) ERR_CODE_2 OFFSET(6) NUMBITS(3) [
            NO_ERROR = 0,
            MACRO_ERROR = 1,
            MACRO_ECC_CORR_ERROR = 2,
            MACRO_ECC_UNCORR_ERROR = 3,
        ...
        pub(crate) ERR_CODE_3 OFFSET(9) NUMBITS(3) [
            NO_ERROR = 0,
            MACRO_ERROR = 1,
            MACRO_ECC_CORR_ERROR = 2,
            MACRO_ECC_UNCORR_ERROR = 3,
        ...
        pub(crate) ERR_CODE_4 OFFSET(12) NUMBITS(3) [
            NO_ERROR = 0,
            MACRO_ERROR = 1,
            MACRO_ECC_CORR_ERROR = 2,
            MACRO_ECC_UNCORR_ERROR = 3,
        ...
        pub(crate) ERR_CODE_5 OFFSET(15) NUMBITS(3) [
            NO_ERROR = 0,
            MACRO_ERROR = 1,
            MACRO_ECC_CORR_ERROR = 2,
            MACRO_ECC_UNCORR_ERROR = 3,
        ...
        pub(crate) ERR_CODE_6 OFFSET(18) NUMBITS(3) [
            NO_ERROR = 0,
            MACRO_ERROR = 1,
            MACRO_ECC_CORR_ERROR = 2,
            MACRO_ECC_UNCORR_ERROR = 3,
        ...
        pub(crate) ERR_CODE_7 OFFSET(21) NUMBITS(3) [
            NO_ERROR = 0,
            MACRO_ERROR = 1,
            MACRO_ECC_CORR_ERROR = 2,
            MACRO_ECC_UNCORR_ERROR = 3,
        ...
        pub(crate) ERR_CODE_8 OFFSET(24) NUMBITS(3) [
            NO_ERROR = 0,
            MACRO_ERROR = 1,
            MACRO_ECC_CORR_ERROR = 2,
            MACRO_ECC_UNCORR_ERROR = 3,
        ...
        pub(crate) ERR_CODE_9 OFFSET(27) NUMBITS(3) [
            NO_ERROR = 0,
            MACRO_ERROR = 1,
            MACRO_ECC_CORR_ERROR = 2,
            MACRO_ECC_UNCORR_ERROR = 3,
    ...
    DIRECT_ACCESS_REGWEN [
        pub(crate) DIRECT_ACCESS_REGWEN OFFSET(0) NUMBITS(1) [],
    ],
    DIRECT_ACCESS_CMD [
        pub(crate) RD OFFSET(0) NUMBITS(1) [],
        pub(crate) WR OFFSET(1) NUMBITS(1) [],
        pub(crate) DIGEST OFFSET(2) NUMBITS(1) [],
    ],
    DIRECT_ACCESS_ADDRESS [
        pub(crate) DIRECT_ACCESS_ADDRESS OFFSET(0) NUMBITS(11) [],
    ],
    DIRECT_ACCESS_WDATA [],
    DIRECT_ACCESS_RDATA [],
    CHECK_TRIGGER_REGWEN [
        pub(crate) CHECK_TRIGGER_REGWEN OFFSET(0) NUMBITS(1) [],
    ],
    CHECK_TRIGGER [
        pub(crate) INTEGRITY OFFSET(0) NUMBITS(1) [],
        pub(crate) CONSISTENCY OFFSET(1) NUMBITS(1) [],
    ],
    CHECK_REGWEN [
        pub(crate) CHECK_REGWEN OFFSET(0) NUMBITS(1) [],
    ],
    CHECK_TIMEOUT [],
    INTEGRITY_CHECK_PERIOD [],
    CONSISTENCY_CHECK_PERIOD [],
    VENDOR_TEST_READ_LOCK [
        pub(crate) VENDOR_TEST_READ_LOCK OFFSET(0) NUMBITS(1) [],
    ],
    CREATOR_SW_CFG_READ_LOCK [
        pub(crate) CREATOR_SW_CFG_READ_LOCK OFFSET(0) NUMBITS(1) [],
    ],
    OWNER_SW_CFG_READ_LOCK [
        pub(crate) OWNER_SW_CFG_READ_LOCK OFFSET(0) NUMBITS(1) [],
    ],
    VENDOR_TEST_DIGEST [],
